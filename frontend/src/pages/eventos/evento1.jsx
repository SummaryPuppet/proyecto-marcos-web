  ...
  return (
    <LayoutPrincipal>
                ...
                <div className="fila-precios rounded shadow-sm bg-dark p-3 overflow-auto mb-3">
                  <div className="d-flex align-items-center justify-content-center flex-nowrap gap-2">
                    ...
                    <div className="celda-precio flex-shrink-0">
                      <div className="etiqueta">PREVENTA FANS</div>

                      <div className="precio">S/ 330.00</div>
                    </div>

                    <div className="celda-precio destacado flex-shrink-0">
                      <div className="etiqueta">PREVENTA INTERBANK</div>

                      <div className="precio">S/ 280.00</div>
                    </div>
                    <div className="celda-precio flex-shrink-0">
                      <div className="etiqueta">PRECIO FULL</div>

                      <div className="precio">S/400.00</div>
                    </div>
                    <div className="celda-precio flex-shrink-0">
                      <div className="etiqueta">CONADIS</div>

                      <div className="precio">S/ 153.00</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="fila-precios rounded shadow-sm bg-dark p-3 overflow-auto ">
                  <div className="d-flex align-items-center justify-content-center flex-nowrap gap-2">
                    ...
                    <div className="celda-precio destacado flex-shrink-0">
                      ...
                      <div className="precio">S/ 123.00</div>
                    </div>
                    <div className="celda-precio flex-shrink-0">
                      <div className="etiqueta">PRECIO FULL</div>
                    ...
                    <div className="celda-precio flex-shrink-0">
                      ...
                      <div className="precio">S/ 99.00</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="descripcion bg-dark py-5 text-center">
        <img src={logoEvento} alt="Megadeth" className="mb-3 img-fluid" />
